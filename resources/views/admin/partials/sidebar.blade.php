        ...
        <div class="sidebar-user">
            <div class="d-flex justify-content-center">
                <div class="flex-shrink-0">
                    <img src="img/avatars/avatar_admin.png" class="avatar img-fluid rounded me-1" alt="Charles Hall" />
                </div>
                <div class="flex-grow-1 ps-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-start">
                        ...
                        <a class="dropdown-item" href="{{route('admin.change')}}"><i class="align-middle me-1"
                                data-feather="pie-chart"></i> Change Password</a>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item @if (request()->routeIs('mapel.index')) active @endif">
                <a class="sidebar-link" href="{{ route('mapel.index') }}">
                    <i class="align-middle" data-feather="credit-card"></i> <span class="align-middle">Mata
                        Pelajaran</span>
                </a>
            </li>
            ...
            {{-- Data Ujian --}}
            <li class="sidebar-item @if (request()->routeIs('ujian.index')) active @endif">
                <a class="sidebar-link" href="{{ route('ujian.index') }}">
